  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text('Choose Reference Object',
              style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          const Text(
              'Choose a reference object to help us calculate accurate measurements:',
      ...
      child: Column(
        children: [
          ...
          if (widget.detectedRectangles.isNotEmpty)
            const Text(
                'Tap the correct rectangle outlining your reference object.')
          else
        ...
        children: [
          Container(
            ...
            child: const Row(children: [
              ...
              Expanded(
                  child: Text(
                      'Tap and drag to draw a box around your reference object.'))
            ]),
          ),
          const SizedBox(height: 8),
          if (widget.errorMessage != null)
        ...
        children: [
          ...
          if (pixelToCmRatio != null) ...[
              ...
              child: (capturedImage == null || imageInfo == null)
                  ...
                  : InteractiveViewer(
                      child: GestureDetector(
                        ...
                        onPanUpdate: (details) =>
                            onDrawMeasurementUpdate(details),
            ...
            OutlinedButton(
                ...
                child: const Text('Clear All Measurements')),
          ] else
            const Expanded(
                child: Center(
                    child: Text('Please select a valid reference object first.'))),
        ],
      ),
    );
  }
...
class ResultsStep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (measurementLines.isNotEmpty && pixelToCmRatio != null) {
      measuredWidth = AIMeasurementService.pixelsToUserUnit(
          measurementLines[0].length, pixelToCmRatio!, preferredUnit);
    }
    if (measurementLines.length >= 2 && pixelToCmRatio != null) {
      measuredHeight = AIMeasurementService.pixelsToUserUnit(
          measurementLines[1].length, pixelToCmRatio!, preferredUnit);
    }
          ...
          if (measuredWidth != null || measuredHeight != null) ...[
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Measured Dimensions:',
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
                  if (measuredWidth != null)
                    Text(
                        'Width: ${MeasurementUtils.formatWithUnit(measuredWidth, preferredUnit)}',
                        style: const TextStyle(fontSize: 16)),
                  if (measuredHeight != null)
                    Text(
                        'Height: ${MeasurementUtils.formatWithUnit(measuredHeight, preferredUnit)}',
                        style: const TextStyle(fontSize: 16)),
                ],
              ),
            ),
